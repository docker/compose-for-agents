...
| [CrewAI](https://github.com/crewAIInc/crewAI) + [Pipelock](https://github.com/luckyPipewrench/pipelock) Secure Research Agent | Single Agent | qwen3(local) | duckduckgo | [./crew-ai-pipelock](./crew-ai-pipelock) | [compose.yaml](./crew-ai-pipelock/compose.yaml) |
